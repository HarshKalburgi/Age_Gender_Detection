...
def process_camera(faceNet, ageNet, genderNet):
...
if __name__ == '__main__':
    ...
    ageList = ['(0-2)', '(4-6)','(8-12)','(12-15)','(15-20)','(25-35)', '(38-43)','(60-100)']
    ...
    if args.image:
        process_image(args.image, faceNet, ageNet, genderNet)
    elif args.camera:
        process_camera(faceNet, ageNet, genderNet)
    else:
